package com.vincent.microservices.currencyexchangesampleservice.Controller;
...
import com.vincent.microservices.currencyexchangesampleservice.Entity.ExchangeValue;
...
public class CurrencyExchangeSampleController {
    ...
    public ExchangeValue retrieveExchangeValue(@PathVariable String fromCurrency, @PathVariable String toCurrency) {
        ...
        exchangeValue = new ExchangeValue(1000L, fromCurrency, toCurrency, conversionMultiple);
